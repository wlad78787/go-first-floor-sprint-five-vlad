...
func (r Running) Calories() float64 {
	...
	return ((CaloriesMeanSpeedMultiplier*meanSpeed + CaloriesMeanSpeedShift) * weight / MInKm * duration.Hours() * MinInHours)
}
...
func (w Walking) Calories() float64 {
	...
	squareMeanSpeed := meanSpeedMInSec * w.Training.meanSpeed()
	weight := w.Training.Weight
	height := w.Height / 100
	return ((CaloriesWeightMultiplier*weight + (squareMeanSpeed/height)*CaloriesSpeedHeightMultiplier*weight) * w.Training.Duration.Hours() * MinInHours)
}
